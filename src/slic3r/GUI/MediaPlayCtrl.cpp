...
{
    // Upstream added GTK-sink and member-based sizing inside wxMediaCtrl2::DoSetSize.
    // This free function only sees the values passed in, so just compute from videoSize.
